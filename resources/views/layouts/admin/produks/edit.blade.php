...
<div class="container">
    ...
    <form action="{{ route('admin.produks.update', $produk->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            @if ($produk->photo_1)
                <button type="button" class="btn btn-danger btn-sm mt-2" onclick="removePhoto('photo_1', 'preview_1')">Hapus
                    Foto</button>
        ...
        <div class="form-group">
            ...
            @if ($produk->photo_2)
                <button type="button" class="btn btn-danger btn-sm mt-2" onclick="removePhoto('photo_2', 'preview_2')">Hapus
                    Foto</button>
        ...
        <div class="form-group">
            ...
            @if ($produk->photo_3)
                <button type="button" class="btn btn-danger btn-sm mt-2" onclick="removePhoto('photo_3', 'preview_3')">Hapus
                    Foto</button>
        ...
        <div class="form-group">
            ...
            @if ($produk->photo_4)
                <button type="button" class="btn btn-danger btn-sm mt-2" onclick="removePhoto('photo_4', 'preview_4')">Hapus
                    Foto</button>
